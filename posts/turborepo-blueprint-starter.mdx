...
You can test this out, if you'd like. But once we have this basic binary we can move forward, linux is all I really care about right now (maybe macos, well for sure macos later, but I may not add windows support).
